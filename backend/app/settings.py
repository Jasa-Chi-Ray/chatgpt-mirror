...
LOCAL_NETWORK_ACCESS_MODE = os.environ.get(
    "LOCAL_NETWORK_ACCESS", "disable"
).strip().lower()
if LOCAL_NETWORK_ACCESS_MODE not in {"enable", "disable"}:
    raise RuntimeError("LOCAL_NETWORK_ACCESS must be enable or disable")
LOCAL_NETWORK_ACCESS = LOCAL_NETWORK_ACCESS_MODE == "enable"
DJANGO_ALLOW_ALL_ORIGINS = (
    LOCAL_NETWORK_ACCESS or DJANGO_ALLOW_ALL_ORIGINS_MODE == "enable"
)
...
SECURE_SSL_REDIRECT = False if LOCAL_NETWORK_ACCESS else env_bool(
    "DJANGO_SECURE_SSL_REDIRECT", False
)
SESSION_COOKIE_SECURE = False if LOCAL_NETWORK_ACCESS else env_bool(
    "DJANGO_SESSION_COOKIE_SECURE", DJANGO_ENV == "PRODUCTION"
)
CSRF_COOKIE_SECURE = False if LOCAL_NETWORK_ACCESS else env_bool(
    "DJANGO_CSRF_COOKIE_SECURE", DJANGO_ENV == "PRODUCTION"
)
